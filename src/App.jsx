      ...
      <div style={fadeStyle}>
        ...
        {phase === "assess" && (
          <div style={cardStyle}>
            ...
            <div style={{ width: "100%", height: 2, background: "rgba(255,255,255,0.06)", borderRadius: 1, marginBottom: 28 }}>
              <div
                style={{
            ...
            <h2 style={{ fontSize: 22, fontWeight: 600, margin: "0 0 4px 0" }}>{categories[currentQ].title}</h2>
            <div
              style={{
                fontFamily: "'JetBrains Mono', monospace",
                fontSize: 11,
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", marginBottom: 24, lineHeight: 1.6, fontWeight: 300 }}>
              {categories[currentQ].question}
            </p>

            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {categories[currentQ].levels.map((level) => {
                const isSelected = answers[categories[currentQ].id] === level.score;
                return (
                  <button
                    key={level.score}
                    onClick={() => handleSelect(categories[currentQ].id, level.score)}
                    style={{
                      background: isSelected ? "rgba(0,229,160,0.1)" : "rgba(255,255,255,0.02)",
                      border: isSelected ? "1px solid rgba(0,229,160,0.3)" : "1px solid rgba(255,255,255,0.06)",
                      borderRadius: 10,
                      padding: "14px 16px",
                      color: "#e8e8ec",
                      fontSize: 13,
                  ...
                  >
                    <span
                      style={{
                        fontFamily: "'JetBrains Mono', monospace",
                        fontSize: 12,
                        color: isSelected ? "#00e5a0" : "rgba(255,255,255,0.25)",
                        minWidth: 28,
                        fontWeight: 600,
                      }}
                    >
        ...
        {phase === "radius" && (
          <div style={cardStyle}>
            ...
            <h2 style={{ fontSize: 22, fontWeight: 600, margin: "0 0 8px 0" }}>決断半径</h2>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", marginBottom: 28, lineHeight: 1.6, fontWeight: 300 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {radiusLevels.map((r) => (
                ...
                >
                  <span style={{ fontSize: 24, opacity: 0.6, minWidth: 36, textAlign: "center" }}>{r.icon}</span>
                  <div>
                    ...
                    <span style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", fontWeight: 300 }}>{r.desc}</span>
                  </div>
                </button>
              ))}
            </div>
          ...
          <div style={{ ...cardStyle, maxWidth: 560 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              ...
              >
                ...
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 14, color: "rgba(255,255,255,0.3)" }}>
                  / 100
                </span>
                <span
                  style={{
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 500 }}>{radiusLevels.find((r) => r.id === radius)?.label}</span>
              </div>
              <p style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", margin: 0, lineHeight: 1.6, fontWeight: 300 }}>
